...
mydict = ['BanHehe', 'BanVy','TenCuaM'] 
# đặt theo thứ tự trong image
    ...
    while True:
        ...
        if faces[1] is not None:
            for idx, face in enumerate(faces[1]):
                ...
                cv.putText(frame, result, (int(face[0]), int(face[1]) - 10), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
                visualize(frame, [faces[0], [face]], tm.getFPS())
